...
%\title{Separating Uncertainty from Accuracy in Learning Analytics}
\title[Accounting for Problem-skipping in Online Learning]{A Problem that Shouldn't be Skipped: Problem Skipping Limits the Accuracy of Ability Estimates in Online Learning}

\author{Annie Johansson}
\email{a.m.johansson2@uva.nl}
...
\affiliation{
  \institution{Prowise Learn}
  \city{Amsterdam}
  \country{The Netherlands}
}

\renewcommand{\shortauthors}{Johansson et al.}
...
\ccsdesc[100]{Social and professional topics~K-12 education}
...
%% THINK ABOUT %%
% Consistent wording for problem-skipping / neutral responding / qm-responding 
% and consistent wording for users/students/children
% need to cite something wrt "many OLEs have a skipping option?"


\section{Introduction}
% Importance of LA for understanding student responses // Most measurement models do not account for uncertain responses 
...
% Make into two paragraphs and elaborate on which problem-skipping features exist 

% Theoretical background & overview of previous literature 
...
%\subsection{IRT models for assessing ability}
    % Overview of IRT research for education 
\subsection{Classical IRT models}
...
%Risk avoidance may also influence item omission in educational practice settings. >> Connection to math anxiety >> If these students are estimated differently because of qm behavior, there is a bias in estimation that needs to  be accounted for. 
...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=0.5\linewidth]{grade_diff.png}
...
\begin{figure}[htbp]
    ...
    %\begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=0.5\linewidth]{rt.png}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.5\linewidth]{session.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{cor.pdf}
...
\begin{acks}
    Annie M.\ Johansson is supported by the Ministry of Education, Culture and Science (Netherlands). Alexander O.\ Savi received funding from the Dutch Research Council (VI.Veni.211G.016).
\end{acks}
