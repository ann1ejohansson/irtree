...
Adaptive learning technologies are increasingly used to support personalized instruction in digital learning environments (ref). By continuously adjusting the difficulty of tasks to match a learner's current level of understanding, such systems aim to provide practice that is neither too easy nor too difficult. To accomplish this, adaptive platforms rely on statistical models that estimate a learner's current proficiency (i.e. a student model, ref) based on their observed performance during practice. Statistical models continuously update these ability estimates, which simultaneously guide the selection of subsequent tasks. Consequently, the accuracy of these models directly affects how effectively tasks can be personalized.
