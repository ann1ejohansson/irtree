...
\begin{figure}[t]
        \centering
        \includegraphics[width=0.3\linewidth]{tree.pdf}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{rt.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\linewidth]{cor.pdf}
